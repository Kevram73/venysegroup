...
@section('content')
 ...
 <div class="content-wrapper">
              ...
              <form action="{{asset('completer-profile')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nationalite" class="form-control" id="" placeholder=" Nationalité">
                  </div>
                  <div class="form-group">
                    <label for="adresse">Adresse</label>
                    <input type="text" name="adresse" class="form-control" id="" placeholder=" Votre adresse">
                  </div>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Preuve de residence</label>
                    <div class="input-group">
                      <div class="custom-file">
